	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item active"><a href="#" class="nav-link"><i class="fa fa-language" aria-hidden="true"></i>Language</a></li>
...
<?php echo $_SESSION['username']; ?></a></li>
 ...
 logout</a></li>
    ...
    <section id="home-section" class="hero">
	      ...
	      <div class="slider-item" style="background-image: url(images/bg13.jpg);">
